...
const cards = [
    ...
    {name:"El Bandolon", num: 17}, {name:"El Violoncello", num: 18}, {name:"La Garza", num: 19},{name:"El Pajaro", num: 20}, {name:"La Mano", num: 21}, {name:"La Bota", num: 22}, {name:"La Luna", num: 23}, {name:"El Cotorro", num: 24}, 
    {name:"El Borracho", num: 25}, {name:"El Negrito", num: 26},{name:"El Corazon", num: 27}, {name:"La Sandia", num: 28}, {name:"El Tambor", num: 29}, {name:"El Camaron", num: 30}, {name:"Las Jaras", num: 31}, {name:"El Musico", num: 32},
    {name:"La Arana", num: 33}, {name:"El Soldado", num: 34}, {name:"La Estrella", num: 35}, {name:"El Cazo", num: 36},{name:"El Mundo", num: 37}, {name:"El Apache", num: 38}, {name:"El Nopal", num: 39}, {name:"El Alacran", num: 40}
];
...
function displayCards(array) {
    ...
    const pathToCard = `./loteriaCards/${array[0].num}.png`;
...
function switchCards() {
    ...
    let numCardsLeft = 40;
    cardsLeft.innerHTML = `Cards left :${numCardsLeft}`;
